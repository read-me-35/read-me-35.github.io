  ...
  return (
    <div className="bg-transparent text-white h-screen flex flex-col justify-center items-center">
      <div className="flex-1 flex flex-col justify-center items-center space-y-4 wrap">
        <button className="bg-red-500 text-white px-4 py-2 rounded-lg w-36 sm:w-40 flex flex-col items-center space-y-2" onClick={props.toPrevPage}>
          <span className="text-center text-base sm:text-lg">Back</span>
        </button>
        <button className="bg-yellow-500 text-white px-4 py-2 rounded-lg w-36 sm:w-40 flex flex-col items-center space-y-2" onClick={props.toNextPage}>
